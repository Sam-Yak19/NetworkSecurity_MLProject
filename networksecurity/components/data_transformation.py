...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        '''
            It initializes the KNN imputer object with the parameter specified in the training_pipeline.py
            file and returns the Pipeline object  with the KNN imputer object as the first step
            ...
            Returns:
               A pipeline object
        '''
        logging.info("Entered get_data_transformer_object method in DataTransformer class")
        try:
