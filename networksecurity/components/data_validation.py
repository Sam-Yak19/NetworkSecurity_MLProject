...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Data frame have columns :{len(dataframe.columns)}")
    ...
    def validate_numeric_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Required numerical columns :{numeric_columns}")
            logging.info(f"Data frame have numeric columns:{len([col for col in numeric_columns if col in dataframe_columns])}")
            ...
            if missing_columns:
                logging.info(f"Missing numeric columns exist",missing_columns)
                return False
            logging.info("No missing numeric columns are there")
            return True
        except Exception as e:
            raise NetworkSecurityException(e,sys)
